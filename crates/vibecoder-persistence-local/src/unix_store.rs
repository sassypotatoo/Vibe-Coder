use super::{
    LocalProjectStateStore, PRODUCT_ROOT_NAME, PROJECT_STATE_ROOT_NAME, STATE_ROOT_NAME,
    persistence_error,
};
...
use uuid::Uuid;
use vibecoder_domain::{ProjectId, Result};
use vibecoder_persistence_contract::{MAX_PERSISTED_STATE_BYTES, PersistedProjectState};
